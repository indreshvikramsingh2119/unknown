...
#     global latest_serial_values
#     while running and ser.is_open:
#         try:
#             line = ser.readline().decode().strip()
#             parts = line.split(",")
#             if len(parts) == 6:
#                 latest_serial_values = parts

#                 # Update A-F (Left panel)
#                 for i, key in enumerate(['A:', 'B:', 'C:', 'D:', 'E:', 'F:']):
#                     if key in entries:
#                         entries[key].delete(0, tk.END)
#                         entries[key].insert(0, parts[i])

#                 # Update auto fields (Center panel)
#                 auto_labels = [
#                     "CV of thread:",
#                     "CV of unbrunt wire:",
#                     "NA CV:",
...
#                     "Total CV:"
#                 ]
#                 for i, key in enumerate(auto_labels):
#                     if key in entries:
#                         entries[key].delete(0, tk.END)
#                         entries[key].insert(0, parts[i])
#         except Exception as e:
    ...
    while running and ser.is_open:
        try:
            ...
            if len(parts) == 6:
                ...
                # Save to history with date and time
                now = datetime.now()
                date_str = now.strftime("%Y-%m-%d")
                time_str = now.strftime("%I:%M %p")
                row_data = [date_str, time_str] + parts
